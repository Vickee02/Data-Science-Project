...
if load:
    ...
    for videodata in mongo_video_data:
        ...
        published_date = videodata.get("Published_At")
        ...
        view_count = videodata.get("View_Count")
        like_count = videodata.get("Like_Count")
        dislike_count = videodata.get("Dislike_Count")
